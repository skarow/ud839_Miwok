...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("grandmother", "майка", R.drawable.family_grandmother));
        ...
        words.add(new Word("uncle", "чичо", R.drawable.family_older_sister));
        words.add(new Word("aunt", "леля", R.drawable.family_older_brother));
